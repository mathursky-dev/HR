            ...
            <div className="relative">
              ...
              {showRoleDropdown && (
                <div className="absolute right-0 mt-2 w-64 bg-slate-900 rounded-xl shadow-2xl border border-slate-700 py-2 z-50 text-slate-200">
                  ...
                  <div className="pt-2 mt-2 border-t border-slate-800 px-3">
                    <button
                      onClick={() => {
                      ...
                      className="w-full text-left py-1 text-[11px] text-rose-400 hover:text-rose-300 flex items-center gap-1.5"
                    >
